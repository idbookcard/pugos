...
@section('title', 'Guest Post - 高质量站点客座文章')
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Guest Post</li>
            </ol>
        </nav>
        ...
        <div class="row">
                        ...
                        <div class="list-group list-group-flush">
                            @foreach(\App\Models\PackageCategory::where('active', true)->orderBy('sort_order')->get() as $cat)
                                <a href="{{ route('packages.category', $cat->slug) }}" 
                                   class="list-group-item list-group-item-action d-flex justify-content-between align-items-center {{ $cat->slug == 'guest-post' ? 'active' : '' }}">
                                    {{ $cat->name }}
                ...
                <div class="card border-0 shadow-sm mt-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('packages.guest-post') }}" class="btn btn-outline-primary active">
            ...
            <div class="col-lg-9">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h1 class="h2 fw-bold mb-0">Guest Post 客座文章</h1>
                    <span class="badge bg-info rounded-pill">{{ $packages->total() }} 个套餐</span>
                </div>
                
                <div class="alert alert-info mb-4">
                    <i class="bi bi-info-circle-fill me-2"></i>Guest Post是在高质量相关网站上发布的永久性客座文章，包含指向您网站的锚文本链接，有效提升网站权威性和相关性。
                </div>
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm hover-shadow transition-shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    @if($package->guest_post_da)
                                    <div class="mb-2">
                                        <span class="badge bg-success">DA {{ $package->guest_post_da }}+</span>
                                    </div>
                                    @endif
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 mb-4 mb-lg-0">
                <h2 class="fw-bold">需要特定行业或权威度的Guest Post？</h2>
                <p class="mb-0">我们可以为您定制专属的Guest Post方案，满足您的特定需求。</p>
            </div>
