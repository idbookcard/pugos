            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                @forelse($recentOrders as $order)
                                    <tr>
                                        <td><a href="{{ route('master.orders.show', $order) }}">{{ $order->order_number }}</a></td>
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('master.orders') }}" class="btn btn-primary btn-sm">{{ __('View All Orders') }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                @forelse($recentUsers as $user)
                                    <tr>
                                        <td><a href="{{ route('master.users.edit', $user) }}">{{ $user->name ?? 'N/A' }}</a></td>
                                        <td>{{ $user->email }}</td>
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('master.users.index') }}" class="btn btn-primary btn-sm">{{ __('View All Users') }}</a>
                    </div>
                </div>
            </div>
        </div>
